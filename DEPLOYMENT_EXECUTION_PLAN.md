...
- [ ] Backend URL obtained: ______________________
- [ ] /ping endpoint works
...
**Checklist**:
- [ ] `frontend/src/config.js` updated with Railway URL
- [ ] File saved
...
**Checklist**:
- [ ] Frontend config committed
- [ ] Pushed to gh-pages branch
- [ ] GitHub Actions workflow completed
- [ ] Frontend URL accessible: ______________________
